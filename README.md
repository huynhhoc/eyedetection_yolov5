...
## <div align="center">EYE DETECTION</div>
...
<p>
<a align="left"> detect_update.py: </a>
...
<p>
<a align="left"> weights/yolov5_eyedetv3.pt: </a>
    The weight was buit based on 7157 images
</p>
```bash - train
<br>
   python3 path/to/train.py --data data/eye.yaml --weights weights/yolov5_eyedetv3.pt --img 640
```
<br>
```bash - detect
<br>
   python3 path/to/detect_update.py --data data/eye.yaml --weights weights/yolov5_eyedetv3.pt --save-crop
```
